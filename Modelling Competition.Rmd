...
train$LotFrontage <- ifelse(is.na(train$LotFrontage), medianas_por_grupo[match(train$Neighborhood,names(medianas_por_grupo))],
                                   train$LotFrontage)
```

```{r}
#Solo sirve para comprobar
train[561,2] #Variable LotFrontage
train[561,44] #Varible Neighborhood
