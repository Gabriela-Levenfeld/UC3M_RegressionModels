...
```{r}
train$dummy_garage <- ifelse(is.na(train$GarageYrBlt),1,0)
train$dummy_masvnr <- ifelse(is.na(train$MasVnrArea),1,0)
train$dummy_RemodYear <- ifelse(is.na(train$YearRemodAdd),1,0)

test$dummy_garage <- ifelse(is.na(test$GarageYrBlt),1,0)
test$dummy_masvnr <- ifelse(is.na(test$MasVnrArea),1,0)
test$dummy_RemodYear <- ifelse(is.na(test$YearRemodAdd),1,0)
