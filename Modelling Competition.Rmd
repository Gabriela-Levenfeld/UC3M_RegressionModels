...
-   For this variables we could apply a ^2 tranformation. However after trying this, we observed that there is no any improvement.

**Positive skweness**:
-   The rest of the vairables have positive skewness, so the proper transformation will be a log tranformation.

**Others**
-   YrSold; variable rara -> Buscar tranformación.
