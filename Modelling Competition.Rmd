...
Furthermore, we delete GarageQual as we consider to have the similar meaning to GarageCond.
...
```{r}
train <- train[,-c(13,22,23,37,38,73,75,76,77,78,41)]
test <- test[,-c(12,21,22,36,37,72,74,75,76,77,40)]
```
