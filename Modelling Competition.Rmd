...
ggplot(datos, aes(x = YearSold)) +
  geom_histogram(binwidth = 1, fill = "skyblue", color = "black", alpha = 0.7) +
  labs(x = "Año de Venta", y = "Frecuencia", title = "Histograma de Año de Venta")

ggplot(datos, aes(x = YearSold)) +
  geom_density(fill = "skyblue", color = "black", alpha = 0.7) +
  labs(x = "Año de Venta", y = "Densidad", title = "Gráfica de Densidad de Año de Venta")
```
...
## Miramos las categorias disferentes entre train_train y train_val
...
```{r}
# Crear el gráfico de cuantiles normales de los residuos
residual_qqnorm <- qqnorm(model_outliers$residuals)

# Obtener los índices de los valores atípicos
outliers_indices <- which(abs(model_outliers$residuals) > 3 * sd(model_outliers$residuals))

# Acceder a los valores atípicos
outliers <- model_outliers$residuals[outliers_indices]
```
