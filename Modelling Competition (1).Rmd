...
-   Alley, con un 93% (train) y un 92% (test) NA ES QUE NO TIENE ACCESO POR UN CALLEJÓN
-   PoolQC (Pool quality) NA ES QUE NO TIENE PISCINA
-   Fence (Fence quality) NA ES QUE NO TIENE VALLA
...
-   FireplaceQu (Fireplace quality) NA ES QUE NO TIENE FIREPLACE


######## YO NO ELIMINABA ESTAS VARIABLES, CREABA OTRA CATEGORÍA PARA LAS NA  ############# 
